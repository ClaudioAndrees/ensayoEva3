...
#1. Validar la cantidad total de equipaj a registrar
total_equipaje = 0
while total_equipaje <= 0:
    try:
        entrada = input("¿Cuántos equipajes desea registar?: ")
...
#2. Ciclo de registro de equipaje
